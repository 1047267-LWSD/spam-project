...
texts = [
    ...
    "Hi there Y I'm Angelina from Swagbucks We're looking for a few motivated people in the U S to join our remote product testing team You'll test and review new products or services — all from the comfort of your home *+ Why you'll love it ¢ & Earn $100 $500 per day @ Just 60 90 mins a day & Same day payments after each"
]

for text in texts:
    print(spam_detect_lstm(text))
