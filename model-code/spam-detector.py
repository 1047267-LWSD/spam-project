...
X = df['TEXT']
y = df['LABEL']
enhanced_features = df[['length', 'caps_ratio','digit_ratio','punctuation_density', 'special_char_density', 'avg_word_length', 'repeated_word_density']]

mi_scores = mutual_info_classif(enhanced_features, y)

feature_names = ['length', 'caps_ratio','digit_ratio','punctuation_density', 'special_char_density', 'avg_word_length', 'repeated_word_density']
